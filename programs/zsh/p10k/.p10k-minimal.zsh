# Generated by Powerlevel10k configuration wizard on 2022-05-23 at 11:36 EDT.
...
() {
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=13
  # Custom icon.
  ...
  # Uncomment to mark impure shells with '!'
  # function my_nix_formatter() {
  #   emulate -L zsh
  #   res=''
  #   if [[ "$IN_NIX_SHELL" == "impure" ]]; then
  #     res='!'
  #   fi
  #   typeset -g my_nix_format=$res
  # }
  # functions -M my_nix_formatter 2>/dev/null
  # typeset -g POWERLEVEL9K_NIX_SHELL_CONTENT_EXPANSION='${$((my_nix_formatter(1)))+${my_nix_format}}'
  #
